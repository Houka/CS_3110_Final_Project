...
(* Initialize sprite by loading all needed images *)
val init: unit -> unit
...
(* [draw img (x,y)] Draws the image onto the current GUI at coordinate (x,y).
 * Note: (0,0) is at the bottom left of the gui window.
 * Precondition: must have a Graphics gui open
 *)
