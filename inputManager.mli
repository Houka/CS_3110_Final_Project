...
(* Setters and getters to manage moving of the game map.
 * Works on relative vectors. *)
...
(* [add_map_offset x y] changes the offset so map can be draw at specified
 * offset postC: offset stays in limits of map_limits *)
